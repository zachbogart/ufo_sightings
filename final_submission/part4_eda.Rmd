...
ggplot(durshape, aes(x = Shape2, y = prop, fill = Shape2)) +
  ...
  xlab("Duration in Minutes") + scale_fill_manual(values=cbPalette, name = "Shape") + ylab("Proportion of Sightings")+ theme(axis.text.x = element_text(angle = 45, hjust = 1)) + theme_light()
```
...
```{r}
ggplot(ufo1950, aes(x = year, fill = Shape2)) + geom_bar(position = "fill") + labs(x='Year', y="Relative Frequency") + ggtitle("Relative Frequency of Shapes over Time")

ufo1950_filtered <- ufo1950 %>% filter(is.na(Shape2) == FALSE)
ggplot(ufo1950_filtered, aes(x = year, fill = Shape2)) + geom_bar(position = "fill") + labs(x='Year', y="Relative Frequency") + ggtitle("Relative Frequency of Shapes over Time (NA excluded)")
```
...
ggplot(ufo1950, aes(x = year, fill = Bin_Dur)) + geom_bar(position = "fill") + scale_fill_manual(values = cbPalette, name = 'Duration') + labs(x = "Year", y='Relative Frequency') + ggtitle('Relative Frequency of Sighting Duration')
```
...
ggplot(dur_overtime, aes(year, Prop, color = Bin_Dur)) + geom_line() +
    ggtitle("UFO Sighting Durations Over Time") + labs(x = "Year", y = "Proportion of Sightings") + theme_light() + scale_color_manual(values=cbPalette, name = "Shape")
