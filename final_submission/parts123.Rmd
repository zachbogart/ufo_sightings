...
# print(nrow(ufo_raw))
library(scales)
ggplot(ufo_raw, aes(x = year)) + geom_histogram(bins = 40, fill='dodgerblue') + ggtitle("The Skewing by Old-Timey Sightings") + scale_y_continuous(name='count (thousands)', labels = c(20,40,60,80),breaks = c(20000,40000,60000,80000)) + geom_vline(xintercept = 1974, color="red") + theme_light()
