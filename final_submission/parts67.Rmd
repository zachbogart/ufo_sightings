...
We feel it's neccesary to acknowledge the use of circles in our visualization. The trouble with radius scaled circles is that users have trouble discerning the difference in value between circles of different sizes. We decided to use circles despite this flaw because the point of the visualization was not to see the minute differences in sizes between circles, but rather the connections between words. If the user wants to see the exact frequency of a word they can click on the word and view the count. Using the size of the circles simply gives the user a glimpse at relative frequency of all the circles. 
