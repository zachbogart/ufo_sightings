...
#### Future Directions
In the future, we would be interested in expanding the scope to see if we could uncover more salient patterns within the dataset. In exploring the datset, we contacted the NUFORC through their hotline and they suggested that patterns may emerge if we connect known missle/aircraft testing to the reported sightings. It would be interesting to explore this claim further and see if removing sightings that relate to known activity cause any patterns to remain. It would also be interesting if we could get more granular information about the location of the sighting. We considered trying to plot latitude and longitude but decided that the town would be too broad to see any intersting differentiation. 
