...
For the interactive component, we were interested in making the dataset easier to explore than it was for us to work with. To do this, we made a force diagram that allowed people to interact with the data naturally, and easily see the connections between different sightings in terms of language used.
